import { Body, Controller, Post, Res, Get, ParseBoolPipe } from "@nestjs/common";
...
export class NotificationsController {
  ...
  @Post("/settings")
  notificationsSettings(@Body("enable", ParseBoolPipe) enable: boolean, @User() user_id: number) {
